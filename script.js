...
const questions = [
  ...
  {
    question:
      "What is the brightest city on Earth when viewed from outer space?",
    answers: [
  ...
  {
    question:
      "The Monster Building in Hong Kong is home to around how many people?",
    answers: [
...
function endQuiz() {
  ...
  if (score <= 1) {
    resultDiv.innerText = `You should travel more...you only scored: ${score} / ${shuffledQuestions.length}`;
  }
}